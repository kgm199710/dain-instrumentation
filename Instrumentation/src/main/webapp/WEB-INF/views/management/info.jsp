	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color:orange"><%=request.getAttribute("tb") %></a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<li class="active"><a href="info?tb=<%=request.getAttribute("tb") %>">INFO</a></li>
					<li class=""><a href="data?tb=<%=request.getAttribute("tb") %>">DATA</a></li>
				</ul>
					...
					<table class="table table-hover text-center table-bordered">
						<thead >
							<tr>
								...
								<th class="text-center fixedHeader" bgcolor="#eeeeee">logger</th>
								...
								<th class="text-center fixedHeader" bgcolor="#eeeeee">sen_init</th>
